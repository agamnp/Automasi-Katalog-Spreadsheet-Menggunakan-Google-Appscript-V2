//     ========     Fungsi Hapus Data Menggunakan Filter Kategori , Jumlah Halaman , Harga ,Tahun Terbit Digital replace data    ========
  ...
  if (!sheet) sheet = ss.getActiveSheet();
      ...
      // Konfigurasi filter
      const filterOptions = {
        kodeRef: { aktif: true, nilaiDiperbolehkan: ['001.01','001.02'
        ]},
...
/**
 * 🚀 Jalankan semua sheet penerbit per batch (tanpa timeout)
 * Kirim notifikasi Telegram setiap batch, akhir, dan kalau ada error
 */
